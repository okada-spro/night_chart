...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220427_test_press_3f33437ad0d851784120_20220427093019_archive.zip';
	const ARCHIVE_SIZE		 = '31971660';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3f33437-27093019';
    const SECONDARY_PACKAGE_HASH = '67f07de-27093019';
	const VERSION			 = '1.4.5';
